...
public class Preguntas3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Preguntas3 frame = new Preguntas3(null);
	 ...
	 * @throws SQLException 
	 */
	public Preguntas3(Alumno a) throws SQLException {
		setTitle("PsicoEvaluaci\u00F3n - Preguntas 3");
		...
		try {
			lblNewLabel_5 = new JLabel(lectura(19));
		...
		try {
			lblNewLabel_6 = new JLabel(lectura(20));
		...
		try {
			lblNewLabel_7 = new JLabel(lectura(21));
		...
		try {
			lblNewLabel_8 = new JLabel(lectura(22));
		...
		JLabel lblNewLabel_10_1 = new JLabel(lectura(25));
		...
		JLabel lblNewLabel_10_1_1 = new JLabel(lectura(26));
		...
		JLabel lblNewLabel_10_1_1_1 = new JLabel(lectura(27));
		...
		JLabel lblNewLabel_10_1_1_1_1 = new JLabel(lectura(28));
		...
		JLabel lblNewLabel_10_1_1_1_1_1 = new JLabel(lectura(29));
		...
		JLabel lblNewLabel_10_1_1_1_1_1_1 = new JLabel(lectura(30));
		...
		*/
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				a.tomarPrueba();
				JOptionPane.showMessageDialog(null,a.mostrarUsuario(),"Resultado", JOptionPane.INFORMATION_MESSAGE);
	...
	void call_guardar(Alumno a) {
		try {
			...
			int edad=a.getEdad();
			String sexo = Character.toString(a.getSexo());
			String respuestas = "";
			for(int i = 0; i < a.getRespuestas().size(); i++) {
				respuestas += a.getRespuestas().get(i);
			}
			String nivelMadurez = a.getNivelMadurez();
			String eleccionProfesional = a.getEleccionVocacional();
			
			String query="insert into alumno"
					+ "(codigo, nombre, correo,edad,sexo,respuestas,nivelmadurez,eleccionprofesional) values "
					+ "(?,?,?,?,?,?,?,?)";
			try {
				...
				s.setInt(4,edad);
				s.setString(5, sexo);
				s.setString(6, respuestas);
				s.setString(7, nivelMadurez);
				s.setString(8, eleccionProfesional);
				s.executeUpdate();
				
				System.out.println("Prueba guardada exitosamente");
